...
var jscolor = {
	...
	color : function(target, prop) {
		...
		function drawPicker(x, y) {
			...
			p.boxB.style['box-shadow'] = '0 0 3px #666';
			...
			switch(modeID) {
				case 0: var padImg = '../../../design/images/jscolor/hs.png'; break;
				case 1: var padImg = '../../../design/images/jscolor/hv.png'; break;
			}
			p.padM.style.backgroundImage = "url('"+jscolor.getDir()+"design/images/jscolor/cross.gif')";
			p.padM.style.backgroundRepeat = "no-repeat";
			p.sldM.style.backgroundImage = "url('"+jscolor.getDir()+"design/images/jscolor/arrow.gif')";
